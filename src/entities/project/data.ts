...
export const projects: Project[] = [
  {
    ...
    carousel: [
      { path: IMAGES_PATH, name: '1', fileType: 'png' },
      { path: IMAGES_PATH, name: '2', fileType: 'png' },
      { path: IMAGES_PATH, name: '3', fileType: 'png' },
      { path: IMAGES_PATH, name: '4', fileType: 'png' },
      { path: IMAGES_PATH, name: '5', fileType: 'png' },
      { path: IMAGES_PATH, name: '6', fileType: 'png' },
    ],
  },
  {
    id: '2',
