    ...
    <Container>
      <Decoration>
        <svg
          ...
          width="1730"
          height="369"
          viewBox="0 0 1730 369"
          fill="none"
          xmlns="http://www.w3.org/2000/svg">
          <path stroke={theme.palette.accent} stroke-width="2">
            <animate
              attributeName="d"
              dur="13000ms"
             ...
             M1 367C28.4288 336.319 8.748 322.802 31.2358 288.438C64.992 236.853 53.3692 153.207 85.532 100.642C202.371 -90.3162 421.651 55.9564 647.418 41.685C805.684 31.6806 928.128 107.687 1047.5 150.931C1189.64 202.423 1310.5 140.642 1516.15 110.726C1676.5 140.642 1661.54 193.067 1729 190.726;

             M1 326.498C28.4288 295.817 28.748 232.3 51.2358 197.936C84.992 146.351 53.3692 152.705 85.532 100.14C202.371 -90.8179 381.651 55.4547 607.418 41.1833C765.684 31.1789 928.128 77.1855 1047.5 120.429C1189.64 171.922 1290.5 70.1402 1496.15 40.2242C1656.5 70.1402 1661.54 152.565 1729 150.224;
        ...
        <svg
          ...
          fill="none"
          xmlns="http://www.w3.org/2000/svg">
          <path stroke={theme.palette.text.disabled} stroke-width="1">
            <animate
              attributeName="d"
              dur="16000ms"
              repeatCount="indefinite"
        ...
        <svg
          ...
          fill="none"
          xmlns="http://www.w3.org/2000/svg">
          <path stroke={theme.palette.text.disabled} stroke-width="4">
            <animate
              attributeName="d"
              dur="6000ms"
              repeatCount="indefinite"
              values="M0 4.87632C152.251 -11.5276 252.221 47.9876 405.063 38.91C593.855 27.6973 704.574 -2.20323 889.318 38.91C1068.12 78.7011 1141.59 180.22 1316.54 234.933C1408.02 263.54 1459.68 283.552 1554.98 292.44C1616.74 298.2 1713.78 292.44 1713.78 292.44;

              M2 11.8764C133 153.5 294.221 94.9877 447.063 85.9101C635.855 74.6974 743.5 -14.5 931.318 5.91009C1110.12 45.7012 1196.5 217 1358.54 251.933C1511.5 299.44 1531.68 230.552 1626.98 239.44C1688.74 245.2 1715.78 299.44 1715.78 299.44;

              M0 4.87632C152.251 -11.5276 252.221 47.9876 405.063 38.91C593.855 27.6973 704.574 -2.20323 889.318 38.91C1068.12 78.7011 1141.59 180.22 1316.54 234.933C1408.02 263.54 1459.68 283.552 1554.98 292.44C1616.74 298.2 1713.78 292.44 1713.78 292.44;
